...
export const ORIGINALS: OriginalEntry[] = [
  ...
  },
  {
    ...
    controls: [
      ...
      { key: "headline", label: "Headline", type: "text", default: "Somewhere between structure and disorder new forms quietly start to emerge", description: "Type laid over the spiral." },

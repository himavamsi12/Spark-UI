...
export const ORIGINALS: OriginalEntry[] = [
  ...
  },
  {
    ...
    name: "Fluid Cursor",
    category: "Background",
    blurb: "A real fluid simulation running on the GPU: the cursor injects velocity and ink that swirls, curls and slowly dissipates across the page.",
    features: [
    ...
    controls: [
      ...
      { key: "background", label: "Background", type: "color", default: "#0f0f0f", description: "Colour behind everything." },
      { key: "textColor", label: "Text Color", type: "color", default: "#f2f0e6", description: "Colour of the headline and nav." },
      ...
      { key: "fontFamily", label: "Font", type: "font", default: "var(--font-instrument-serif), serif", description: "Typeface for the headline." },
      { key: "textScale", label: "Text Scale", type: "fontScale", default: 100, min: 50, max: 200, step: 10, description: "Relative size of the text." },
    ],
  },
  {
    ...
    controls: [
      ...
      { key: "buttonLabel", label: "Button Label", type: "text", default: "Engage", description: "Label once the ring has filled." },
      ...
      { key: "fontFamily", label: "Font", type: "font", default: "var(--font-barlow-condensed), sans-serif", description: "Typeface used throughout." },

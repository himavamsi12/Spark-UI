...
export default function ComponentFlowHero({ className }: { className?: string }) {
  ...
  useEffect(() => {
    ...
    const onOver = (e: MouseEvent) => {
      if ((e.target as HTMLElement).closest(".cfh-card")) tween.pause();
    };
  ...
  return (
    ...
    >
      <style>{`
        ...
        .cfh-card img { transition: opacity 480ms ease, filter 480ms ease; }
        .cfh-track:hover .cfh-card:not(:hover) img {
          opacity: 0.55;
